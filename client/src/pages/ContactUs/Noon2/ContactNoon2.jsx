  ...
  const contactValidation = yup.object({
    ...
    contactType: yup
      ...
      .oneOf(
        ...
        lang === 'ar' ? 'يجب أن يكون نوع الاتصال أحد القيم التالية: شكاوي، اقتراحات، خدمة العملاء' : 'ContactType must be one of the following values: complaints, suggestions, customerService'
      ),
  })
      ...
      <Container>
        <InputBase
          ...
          sx={{
            ...
            '& input::placeholder': {
              fontSize: '20px',
              // color: props.color?.textColor ? props.color?.textColor : '#333',
    ...
    >
      ...
      >
        <Grid
          ...
          width={'50%'}
          sx={{
            backgroundImage: backgroundImag
              ? `url(${backgroundImag})`
                ...
                <Container>
                      ...
                      style={{
                        ...
                        border:
                          formik.errors.contactType && formik.touched.contactType
                            ? `2px solid red `
                            : `2px solid ${ContactNoon2Style.color?.borderColor
                  ...
                  >
                    ...
                    disabled={isLoading}
                      variant="contained"
                      sx={{
                        backgroundColor: ContactNoon2Style.button?.backgroundColor
