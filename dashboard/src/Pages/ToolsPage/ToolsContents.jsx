          ...
          <form onSubmit={formik.handleSubmit}>
            <Box
              ...
              sx={{
                height: "200px",
                width: "100%",
                border: `1px solid ${customColors.text} !important`,
                fontSize: "18px",
                p: 2,
                outline: "none",
                borderRadius: "10px",
...
const ToolsContents = () => {
  ...
  const [deleteMetaAnalytics,{isLoading:deleteLoad}] = useDeleteMetaAnalyticsMutation();
          ...
          {data?.data?.map((item, index) => (
            <Box key={index}>
              ...
              <Box textAlign={lang == "en" ? "right" : "left"} mt={2}>
                <ButtonBase
                  onClick={() => handleEdit(item, contentData[`${item.key}`][`${lang}`])}
                  sx={{
                    bgcolor: customColors.main,
                    color: "white",
                    width: "fit-content",
