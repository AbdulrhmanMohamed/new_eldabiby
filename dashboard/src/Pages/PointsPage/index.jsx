...
export default function PointsPage() {
  ...
  const { data, isError } = useGetPointQuery();
  ...
  return (
    <>
      ...
      <PointModal point={!isError && points} open={open} setOpen={setOpen} />
    </>
  );
}
